...
export interface ApiSideNoteSideNote extends Schema.CollectionType {
  ...
  attributes: {
    ...
    flix: Attribute.Relation<'api::side-note.side-note', 'oneToOne', 'api::flix.flix'> & Attribute.Private;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<'api::side-note.side-note', 'oneToOne', 'admin::user'> & Attribute.Private;
    updatedBy: Attribute.Relation<'api::side-note.side-note', 'oneToOne', 'admin::user'> & Attribute.Private;
  };
}
